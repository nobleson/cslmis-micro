<template>
  <div class="vue-form-wizard" :class="[stepSize, {vertical: isVertical}]" @keyup.right="focusNextTab"
    ...
    <div class="wizard-header">
      <slot name="title">
        <h4 class="wizard-title">Artisan Form Wizard</h4>
        <p class="category">Complete the form and skip by clicking the Next button</p>
      </slot>
    </div>
...
<script>
  ...
  export default {
    ...
    props: {
      title: {
        type: String,
        default: 'Artisan Form Wizard'
      },
      subtitle: {
        type: String,
        default: 'Complete the form and skip by clicking the Next button'
      },
      nextButtonText: {
        type: String,
        default: 'Next'
