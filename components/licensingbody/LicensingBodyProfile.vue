<template>
  <section style="background: #ededed; padding-bottom: 100px">
    ...
    <mdb-container free-bird>
     ...
     <b-link @click="$emit('changeComponent',{component: 'LicensingBodyView', id: null})"  href="#" class="card-link text-white"><mdb-icon icon="arrow-left" size="lg" class="text-white" /> View All License Bodies</b-link>
    <mdb-card class="weather-card">
      <mdb-card-body class="pb-3">
      <div class="d-flex flex-row">
        <img :src="licensingBodyData.logo" class="rounded-circle mr-3" height="170px" width="150px" alt="avatar" />
        <div>
          <mdb-card-title class="font-weight-bold mb-2">{{licensingBodyData.fullname}}</mdb-card-title> 
          <mdb-card-text><mdb-icon icon="clock" class="pr-2" /><timeago :datetime="licensingBodyData.dateRegistered"></timeago></mdb-card-text>
        </div>
      </div>
        <mdb-card-title class="font-weight-bold">{{licensingBodyData.accronym}}</mdb-card-title>
        <mdb-card-text>{{licensingBodyData.missionStatment}}</mdb-card-text>
        <div>
            <gmap-map
              :center="center"
              :zoom="12"
        ...
        <mdb-tooltip trigger="hover" :options="{placement: 'top'}">
            <div class="tooltip">Website</div>
                    <b-link :href="licensingBodyData.websiteAddress" target="_blank" class="float-right p-1 my-1">Visit Website</b-link>
          </mdb-tooltip>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="float-right font-weight-normal">
                      <p class="mb-1">{{licensingBodyData.telephoneNumber}}</p>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="float-right font-weight-normal">
                      <p class="mb-1">{{licensingBodyData.emailAddress}}</p>
                    </td>
                    <td class="float-right mr-3">
                  ...
                  <tr>
                    ...
                    <td class="float-right font-weight-normal">
                      <p class="mb-1">{{licensingBodyData.contactAddress}}</p>
                    </td>
                    <td class="float-right mr-3">
                  ...
                  <tr>
                    ...
                    <td class="float-right font-weight-normal">
                      <p class="mb-1">{{licensingBodyData.city}}</p>
                    </td>
                    <td class="float-right mr-3">
