  ...
  <section style="background: #ededed; padding-bottom: 100px">
    ...
    <mdb-card class="weather-card">
      ...
      <div class="d-flex flex-row">
        <img :src="regulatoryBodyData.logo" class="rounded-circle mr-3" height="170px" width="150px" alt="avatar" />
        <div>
          <mdb-card-title class="font-weight-bold mb-2">{{regulatoryBodyData.fullname}}</mdb-card-title> 
          <mdb-card-text><mdb-icon icon="clock" class="pr-2" /><timeago :datetime="regulatoryBodyData.dateRegistered"></timeago></mdb-card-text>
        </div>
      </div>
        <mdb-card-title class="font-weight-bold">{{regulatoryBodyData.accronym}}</mdb-card-title>
        <mdb-card-text>{{regulatoryBodyData.missionStatment}}</mdb-card-text>
        <div>
            <gmap-map
              :center="center"
              :zoom="12"
        ...
        <mdb-tooltip trigger="hover" :options="{placement: 'top'}">
            <div class="tooltip">Website</div>
                    <b-link :href="regulatoryBodyData.websiteAddress" target="_blank" class="float-right p-1 my-1">Visit Website</b-link>
          </mdb-tooltip>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="float-right font-weight-normal">
                      <p class="mb-1">{{regulatoryBodyData.telephoneNumber}}</p>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="float-right font-weight-normal">
                      <p class="mb-1">{{regulatoryBodyData.emailAddress}}</p>
                    </td>
                    <td class="float-right mr-3">
                  ...
                  <tr>
                    ...
                    <td class="float-right font-weight-normal">
                      <p class="mb-1">{{regulatoryBodyData.contactAddress}}</p>
                    </td>
                    <td class="float-right mr-3">
                  ...
                  <tr>
                    ...
                    <td class="float-right font-weight-normal">
                      <p class="mb-1">{{regulatoryBodyData.city}}</p>
                    </td>
                    <td class="float-right mr-3">
