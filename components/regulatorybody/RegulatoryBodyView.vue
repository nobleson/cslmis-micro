  ...
  <mdb-col class="m-5" cols="12">
    ...
    <mdb-tab-content>
      <mdb-tab-pane class="fade" key="show1" v-if="pillsActive==0">
        <mdb-row>
               <b-col v-for="body in processRegulatoryBody" :key="body.id" cols="3">
                <div>
                  <mdb-card wide>
...
export default {
   ...
   data() {
    ...
    computed: {
          ...mapGetters({regulatoryBodies: 'regulatorybody/getRegulatoryBodies', isContentLoading: 'regulatorybody/getLoaderStatus'}),
