...
<section>
    <b-row>
            <b-col align-self="end"  class="pb-3 pl-auto" cols="12">
                <b-button color=""  @click="$emit('changeComponent',{component: 'NewRetrenchement', id: null})" class="">Create New</b-button>
             <hr>
            </b-col>
            <hr>
      </b-row>
                ...
                <div>
                  <mdb-card wide>
                    ...
                    <mdb-card-body class="text-center pb-0" cascade>
                      ...
                      <mdb-card-footer class="text-muted mt-4"><mdb-btn outline="default" darkWaves size="lg" @click="$emit('changeComponent',{component:'RetrenchementDetail',data: null})" >Manage</mdb-btn></mdb-card-footer>
                    </mdb-card-body>
                  </mdb-card>
                  </div>
                </b-col>
...
export default {
   ...
   data() {
    ...
    computed: {
          ...mapGetters({retrenchment: 'retrenchment/getRetrenchement'}),
    ...
    methods: {
      ...mapActions({loadRetrenchement: 'retrenchement/loadRetrenchement'}),
        create() {
