<template>
  <section style="background: #ededed; padding-bottom: 100px">
    ...
    <mdb-container free-bird>
     ...
     <b-link @click="$emit('changeComponent',{component: 'AssesorView', id: null})"  href="#" class="card-link text-white"><mdb-icon icon="arrow-left" size="lg" class="text-white" /> View All Regulatory Bodies</b-link>
    <mdb-card class="weather-card">
      <mdb-card-body class="pb-3">
      <div class="d-flex flex-row">
        <img :src="assesorsData.photo" class="rounded-circle mr-3" height="120px" width="150px" alt="avatar" style="max-height: 100px; max-width: 150px"/>
        
        <div>
          <mdb-card-title class="font-weight-bold mb-2">{{assesorsData.surname}}{{assesorsData.middleName}}{{assesorsData.otherName}}</mdb-card-title> 
          <mdb-card-text><mdb-icon icon="clock" class="pr-2" /><timeago :datetime="assesorsData.dateRegistered"></timeago></mdb-card-text>
        </div>
      </div>
        <mdb-card-title class="font-weight-bold">{{assesorsData.city}}</mdb-card-title>
        <mdb-card-text>{{assesorsData.contactAddress}}</mdb-card-text>
        <div>
            <gmap-map
              :center="center"
              :zoom="12"
        ...
        <mdb-tooltip trigger="hover" :options="{placement: 'top'}">
            <div class="tooltip">Website</div>
                    <b-link :href="assesorsData.registrationNumber" target="_blank" class="float-right p-1 my-1">Verify Registration</b-link>
          </mdb-tooltip>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="float-right font-weight-normal">
                      <p class="mb-1">{{assesorsData.phoneNumber}}</p>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="float-right font-weight-normal">
                      <p class="mb-1">{{assesorsData.emailAddress}}</p>
                    </td>
                    <td class="float-right mr-3">
                  ...
                  <tr>
                    ...
                    <td class="float-right font-weight-normal">
                      <p class="mb-1">{{assesorsData.state}}</p>
                    </td>
                    <td class="float-right mr-3">
                  ...
                  <tr>
                    ...
                    <td class="float-right font-weight-normal">
                      <p class="mb-1">{{assesorsData.localGovernment}}</p>
                    </td>
                    <td class="float-right mr-3">
                      <mdb-icon icon="map-marked" size="lg" class="amber-text" />
                    </td>
                   ...
                   <tr>
                    ...
                    <td class="float-right font-weight-normal">
                      <p class="mb-1">{{assesorsData.nationality}}</p>
                    </td>
                    <td class="float-right mr-3">
                      <mdb-icon icon="map-marked" size="lg" class="amber-text" />
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="float-right font-weight-normal">
                      <p class="mb-1">{{assesorsData.gender}}</p>
                    </td>
                    <td class="float-right mr-3">
